            ...
            if sub_id != "N/A":
                ...
                if week_int < 8:
                    if strm == "sleep" and typ == "fitbit":
                        ...
                        totaldata.loc[id_key[0], "Fitbit - Heart Rate"] = totaldata["Fitbit - Heart Rate"][
                                                                              id_key[0]] + 1
                        ...
                        totaldata.loc[id_key[0], "Study App - EMA - BM"] = totaldata["Study App - EMA - BM"][
                                                                               id_key[0]] + 1
                else:
                    if strm == "sleep" and typ == "fitbit":
                        totaldata.loc[id_key[1], "Fitbit - Sleep"] = totaldata["Fitbit - Sleep"][id_key[1]] + 1
                    elif strm == "hr" and typ == "fitbit":
                        totaldata.loc[id_key[1], "Fitbit - Heart Rate"] = totaldata["Fitbit - Heart Rate"][
                                                                              id_key[1]] + 1
                    elif strm == "activities" and typ == "fitbit":
                        ...
                        totaldata.loc[id_key[1], "Study App - EMA - BM"] = totaldata["Study App - EMA - BM"][
                                                                               id_key[1]] + 1

        i = i + 1
    # %%
    # Write dataframe to Excel file
    totaldata.to_csv(filename + ".csv")
